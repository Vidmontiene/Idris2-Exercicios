...
(define Main-main (lambda (ext-0) (let ((act-1 (PreludeC-45IO-prim__putStr "Nota 1: \xa;" ext-0))) (let ((act-2 (PreludeC-45IO-prim__getStr ext-0))) (let ((u--n1 (cast-string-double act-2))) (let ((act-3 (PreludeC-45IO-prim__putStr "Nota 2: \xa;" ext-0))) (let ((act-4 (PreludeC-45IO-prim__getStr ext-0))) (let ((u--n2 (cast-string-double act-4))) (PreludeC-45IO-prim__putStr (string-append (string-append "Media: " (PreludeC-45Show-u--show_Show_Double (/ (+ u--n1 u--n2) 2.0))) "\xa;") ext-0)))))))))
