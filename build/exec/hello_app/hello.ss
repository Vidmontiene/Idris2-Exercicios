...
(define Main-main (lambda (ext-0) (let ((act-1 (PreludeC-45IO-prim__putStr "Hello, World!\xa;" ext-0))) (PreludeC-45IO-prim__putStr (PreludeC-45Show-u--show_Show_Integer 5) ext-0))))
