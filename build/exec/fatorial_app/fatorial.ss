...
(define Main-fatorial (lambda (arg-0) (cond ((equal? arg-0 0) 1)(else (let ((e-0 (- arg-0 1))) (* (+ e-0 1) (Main-fatorial e-0)))))))
...
(define Main-main (lambda (ext-0) (let ((act-1 (PreludeC-45IO-prim__putStr "Digite um n\xfa;mero:\xa;" ext-0))) (let ((act-2 (PreludeC-45IO-prim__getStr ext-0))) (let ((u--n (PreludeC-45Types-prim__integerToNat (cast-string-int act-2)))) (PreludeC-45IO-prim__putStr (string-append (string-append "Fatorial: " (PreludeC-45Show-u--show_Show_Nat (Main-fatorial u--n))) "\xa;") ext-0))))))
