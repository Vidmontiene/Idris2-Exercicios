...
(define csegen-3 (vector (lambda (arg-5919) (lambda (arg-5922) (+ arg-5919 arg-5922))) (lambda (arg-5929) (lambda (arg-5932) (* arg-5929 arg-5932))) (lambda (arg-5939) arg-5939)))
...
(define Main-mostrarUm (lambda (arg-0 arg-1) (cond ((equal? arg-0 0) (string-append "[" (string-append (PreludeC-45Show-u--show_Show_Nat arg-1) "]"))) (else "[X]"))))
(define Main-renderizar (lambda (arg-0 arg-1 arg-2) (cond ((equal? arg-0 0) "")(else (let ((e-0 (- arg-0 1))) (let ((e-4 (car arg-1))) (let ((e-5 (cdr arg-1))) (string-append (Main-mostrarUm e-4 arg-2) (string-append " " (Main-renderizar e-0 e-5 (+ arg-2 1)))))))))))
(define Main-intToFin (lambda (arg-0 arg-1) (cond ((equal? arg-0 0) '())(else (let ((e-0 (- arg-0 1))) (let ((sc0 (PreludeC-45EqOrd-u--C-60_Ord_Integer arg-1 0))) (cond ((equal? sc0 1) '()) (else (cond ((equal? arg-1 0) (box 0))(else (let ((sc1 (Main-intToFin e-0 (- arg-1 1)))) (if (null? sc1) '() (let ((e-1 (unbox sc1))) (box (+ e-1 1)))))))))))))))
(define Main-case--loop-11619 (lambda (arg-0 arg-1 arg-2 arg-3) (if (null? arg-3) (lambda (world-0) (let ((act-1 (PreludeC-45IO-prim__putStr "Entrada inv\xe1;lida!\xa;" world-0))) (Main-loop arg-0 arg-1 world-0))) (let ((e-2 (unbox arg-3))) (let ((sc1 (PreludeC-45EqOrd-u--C-61C-61_Eq_Integer e-2 -1))) (cond ((equal? sc1 1) (lambda (eta-0) (PreludeC-45IO-prim__putStr "Encerrando...\xa;" eta-0))) (else (lambda (eta-0) (Main-case--caseC-32blockC-32inC-32caseC-32blockC-32inC-32loop-11685 arg-0 arg-1 arg-2 e-2 (Main-intToFin arg-0 e-2) eta-0)))))))))
(define Main-loop (lambda (arg-0 arg-1 ext-0) (let ((act-1 (PreludeC-45IO-prim__putStr (string-append (string-append "\xa;Assentos: " (Main-renderizar arg-0 arg-1 0)) "\xa;") ext-0))) (let ((act-2 (PreludeC-45IO-prim__putStr "Digite o n\xfa;mero do assento (ou -1 para sair):\xa;" ext-0))) (let ((act-3 (PreludeC-45IO-prim__getStr ext-0))) ((Main-case--loop-11619 arg-0 arg-1 act-3 (DataC-45String-parseInteger csegen-3 (vector csegen-3 (lambda (arg-6034) (- 0 arg-6034)) (lambda (arg-6040) (lambda (arg-6043) (- arg-6040 arg-6043)))) act-3)) ext-0))))))
...
(define DataC-45Vect-updateAt (lambda (arg-2 arg-3 arg-4) (cond ((equal? arg-2 0) (let ((e-5 (car arg-4))) (let ((e-6 (cdr arg-4))) (cons (arg-3 e-5) e-6))))(else (let ((e-2 (- arg-2 1))) (let ((e-9 (car arg-4))) (let ((e-10 (cdr arg-4))) (cons e-9 (DataC-45Vect-updateAt e-2 arg-3 e-10)))))))))
(define Main-reservar (lambda (arg-1 arg-2) (let ((sc0 (DataC-45Vect-index arg-1 arg-2))) (cond ((equal? sc0 0) (box (DataC-45Vect-updateAt arg-1 (lambda (_-11476) 1) arg-2))) (else '())))))
(define Main-case--caseC-32blockC-32inC-32caseC-32blockC-32inC-32loop-11685 (lambda (arg-0 arg-1 arg-2 arg-3 arg-4 ext-0) (if (null? arg-4) (let ((act-1 (PreludeC-45IO-prim__putStr "\xcd;ndice fora do intervalo!\xa;" ext-0))) (Main-loop arg-0 arg-1 ext-0)) (let ((e-2 (unbox arg-4))) (let ((sc1 (Main-reservar e-2 arg-1))) (if (null? sc1) (let ((act-1 (PreludeC-45IO-prim__putStr "Assento j\xe1; est\xe1; ocupado!\xa;" ext-0))) (Main-loop arg-0 arg-1 ext-0)) (let ((e-3 (unbox sc1))) (let ((act-1 (PreludeC-45IO-prim__putStr "Reserva realizada com sucesso!\xa;" ext-0))) (Main-loop arg-0 e-3 ext-0)))))))))
(define Main-criarAssentos (lambda (arg-0) (cond ((equal? arg-0 0) '())(else (let ((e-0 (- arg-0 1))) (cons 0 (Main-criarAssentos e-0)))))))
(define PreludeC-45Types-prim__integerToNat (lambda (arg-0) (let ((sc0 (or (and (<= 0 arg-0) 1) 0))) (cond ((equal? sc0 0) 0)(else arg-0)))))
(define Main-main (lambda (ext-0) (let ((act-1 (PreludeC-45IO-prim__putStr "Digite o n\xfa;mero de asssentos que existir\xe3;o:\xa;" ext-0))) (let ((act-2 (PreludeC-45IO-prim__getStr ext-0))) (let ((u--n (PreludeC-45Types-prim__integerToNat (cast-string-int act-2)))) (Main-loop u--n (Main-criarAssentos u--n) ext-0))))))
