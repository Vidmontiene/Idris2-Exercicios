...
(define Main-main (lambda (ext-0) (let ((act-1 (PreludeC-45IO-prim__putStr "Digite n\xfa;meros separados por espa\xe7;o:\xa;" ext-0))) (let ((act-2 (PreludeC-45IO-prim__getStr ext-0))) (let ((u--partes (DataC-45String-words act-2))) (let ((u--nums (PreludeC-45TypesC-45List-mapAppend '() (lambda (u--x) (cast-string-boundedInt u--x 63)) u--partes))) (let ((u--dobrados (PreludeC-45TypesC-45List-mapAppend '() (lambda (u--x) (bs* u--x (blodwen-toSignedInt 2 63) 63)) u--nums))) (PreludeC-45IO-prim__putStr (string-append (string-append "Dobrado: " (PreludeC-45Show-u--show_Show_C-40ListC-32C-36aC-41 (cons (lambda (u--x) (PreludeC-45Show-u--show_Show_Int u--x)) (lambda (u--d) (lambda (u--x) (PreludeC-45Show-u--showPrec_Show_Int u--d u--x)))) u--dobrados)) "\xa;") ext-0))))))))
